...
## Get this from `nm interrupts.o` in bash
...
int_bottom:
  ...
  # No need to clear the pushed values
  # addl $5, %esp
  # We will overrite the value itself, becuase the method returns esp
  movl %eax, %esp # Switch the task
